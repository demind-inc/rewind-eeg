...
rewind_dir = os.path.dirname(os.path.realpath(__file__))
...
def show_image_target_frame(video_file_path,file_name,target_frame):
    ...
    target_dir = os.path.join(os.path.dirname(os.path.dirname(rewind_dir)), "output", "images")
    screenshot_filename = f"{target_dir}/{file_name}.png"
